...
PLUGIN_ID = 10698782
PLUGIN_VERSION = "1.2.2-en"

TXT = {
    "en": {
        "cmd_name": "AssignToLayer (EN)",
        "help": "Assigns the selected object hierarchy to a layer.",
        "dlg_title": "AssignToLayer (EN) v{ver}",
        "tip": "Tip: New layer wins. Selecting a child picks its closest parent and the whole branch.",
...
if __name__ == "__main__":
    print("[AssignToLayer EN] loaded (v{ver})".format(ver=PLUGIN_VERSION))".format(ver=PLUGIN_VERSION))
